...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mdp`.`linkableworkpersons` (`name` INT, `url` INT, `id` INT, `role` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mdp`.`linkablecompanyaffiliations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mdp`.`linkablecompanyaffiliations` (`name` INT, `url` INT, `id` INT, `start` INT, `end` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mdp`.`linkableworkcompanies`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mdp`.`linkableworkcompanies` (`name` INT, `url` INT, `id` INT, `role` INT);
...
SELECT p.shortName AS name, imgs.url AS url, p.id AS id, roles.name AS role 
...
SELECT p.shortName AS name, imgs.url AS url, p.id AS id, caf.start AS start, caf.end AS end
...
SELECT c.shortName AS name, imgs.url AS url, c.id AS id, roles.name AS role 
