...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mdp`.`linkablepersonaffiliations` (`name` INT, `url` INT, `company` INT, `person` INT, `start` INT, `end` INT);
...
SELECT c.shortName AS name, imgs.url AS url, caf.company AS company, caf.person AS person, caf.start AS start, caf.end AS end
FROM companyaffiliations AS caf 
